...
var MatTooltip = class _MatTooltip {
  ...
  _updateTooltipMessage() {
    if (this._tooltipInstance) {
      ...
      this._ngZone.onMicrotaskEmpty.pipe((0, import_operators.take)(1), (0, import_operators.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._tooltipInstance) {
          this._overlayRef.updatePosition();
        }
      });
...
//# sourceMappingURL=chunk-VAV3W6A2.js.map
