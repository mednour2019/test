...
import {
  MAT_FORM_FIELD,
  MatFormField
} from "./chunk-G2ZGMHF4.js";
import {
  Overlay,
  OverlayConfig,
  OverlayModule
} from "./chunk-AYROG2KY.js";
import {
  CdkScrollableModule,
  ViewportRuler
} from "./chunk-NRCJOSKP.js";
import {
  TemplatePortal
} from "./chunk-FKGKCOJB.js";
import {
  animate,
  group,
  state,
  ...
  transition,
  trigger
} from "./chunk-LW77REJD.js";
import {
  NG_VALUE_ACCESSOR
} from "./chunk-76UGGZBQ.js";
import "./chunk-SVHDWKT2.js";
import {
...
var MatAutocompleteTrigger = class _MatAutocompleteTrigger {
  constructor(_element, _overlay, _viewContainerRef, _zone, _changeDetectorRef, scrollStrategy, _dir, _formField, _document, _viewportRuler, _defaults) {
    ...
    this.optionSelections = (0, import_rxjs.defer)(() => {
      ...
      return this._zone.onStable.pipe((0, import_operators.take)(1), (0, import_operators.switchMap)(() => this.optionSelections));
    });
  ...
  _subscribeToClosingActions() {
    const firstStable = this._zone.onStable.pipe((0, import_operators.take)(1));
    ...
    return (0, import_rxjs.merge)(firstStable, optionChanges).pipe(
