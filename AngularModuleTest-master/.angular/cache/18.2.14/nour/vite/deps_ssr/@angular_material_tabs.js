...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  ngAfterContentInit() {
    ...
    this._ngZone.onStable.pipe((0, import_operators.take)(1)).subscribe(realign);
    (0, import_rxjs.merge)(dirChange, resize, this._items.changes, this._itemsResized()).pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(() => {
      this._ngZone.run(() => {
