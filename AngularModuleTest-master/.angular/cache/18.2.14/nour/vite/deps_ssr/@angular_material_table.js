...
var _CoalescedStyleScheduler = class __CoalescedStyleScheduler {
  ...
  _createScheduleIfNeeded() {
    ...
    this._getScheduleObservable().pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(() => {
  ...
  _getScheduleObservable() {
    return this._ngZone.isStable ? (0, import_rxjs.from)(Promise.resolve(void 0)) : this._ngZone.onStable.pipe((0, import_operators.take)(1));
  }
  static {
...
var CdkTable = class _CdkTable {
  ...
  renderRows() {
    ...
    if (this._ngZone && NgZone.isInAngularZone()) {
      this._ngZone.onStable.pipe((0, import_operators.take)(1), (0, import_operators.takeUntil)(this._onDestroy)).subscribe(() => {
        this.updateStickyColumnStyles();
      });
    } else {
      this.updateStickyColumnStyles();
