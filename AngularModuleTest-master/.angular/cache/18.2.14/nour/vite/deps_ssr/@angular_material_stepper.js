...
import {
  MatIcon,
  MatIconModule
} from "./chunk-U7C6ZKNM.js";
import "./chunk-773RZRKW.js";
import "./chunk-OUHVH6DG.js";
import {
  CdkPortalOutlet,
  PortalModule,
  TemplatePortal
...
var MatStep = class _MatStep extends CdkStep {
  constructor(stepper, _errorStateMatcher, _viewContainerRef, stepperOptions) {
    ...
    this._isSelected = import_rxjs2.Subscription.EMPTY;
...
var MatStepper = class _MatStepper extends CdkStepper {
  ...
  constructor(dir, changeDetectorRef, elementRef) {
    ...
    this._iconOverrides = {};
    this._animationDone = new import_rxjs2.Subject();
  ...
  ngAfterContentInit() {
    ...
    this._animationDone.pipe(
      ...
      (0, import_operators2.distinctUntilChanged)((x, y) => x.fromState === y.fromState && x.toState === y.toState),
