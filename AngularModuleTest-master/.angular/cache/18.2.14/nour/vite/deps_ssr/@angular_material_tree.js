...
import {
  DataSource,
  isDataSource
} from "./chunk-SVHDWKT2.js";
import {
  Directionality,
  MatCommonModule
} from "./chunk-Z5SED4KL.js";
import "./chunk-QNCNWGKF.js";
import {
  Attribute,
...
var CdkTree = class _CdkTree {
  ...
  _observeRenderChanges() {
    ...
    if (dataStream) {
      this._dataSubscription = dataStream.pipe((0, import_operators.takeUntil)(this._onDestroy)).subscribe((data) => this.renderNodeChanges(data));
...
var CdkNestedTreeNode = class _CdkNestedTreeNode extends CdkTreeNode {
  ...
  ngAfterContentInit() {
    ...
    } else if ((0, import_rxjs.isObservable)(childrenNodes)) {
      childrenNodes.pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe((result) => this.updateChildrenNodes(result));
    }
...
var MatTreeFlatDataSource = class extends DataSource {
  ...
  constructor(_treeControl, _treeFlattener, initialData) {
    ...
    this._data = new import_rxjs2.BehaviorSubject([]);
    if (initialData) {
